...
import proxy.core.Book;
import proxy.core.BookDao;
import proxy.core.BookDaoImpl;
import proxy.db.*;
...
public class BookServlet extends HttpServlet {
    ...
    public void init() {
        ...
        DatabaseConfig config = new DatabaseConfig("jdbc:mysql://localhost:3306/bookstore", "root", "123456");
